...
return array(
    array(
        'name' => esc_html__('Sidebar', 'highlt'),
        'id' => 'sidebar-1',
        'description' => esc_html__('Add widgets here.', 'highlt'),
    ...
    array(
        'name' => esc_html__('Products Sidebar', 'highlt'),
        'id' => 'product-sidebar',
        'description' => esc_html__('Add widgets here.', 'highlt'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
    ...
    array(
        'name' => esc_html__('Footer Widget Area', 'highlt'),
        'id' => 'footer-widget',
        'description' => esc_html__('Add widgets here.', 'highlt'),
